...
**Description du projet et des données utilisées:**
multitableaux avec problématique de discrimination ou liens de causalité à mesurer
...
**Description du projet et des données utilisées:**
Intégration de données métabolomiques publiées dans Metabolights, en vue d'un interfaçage avec les réseaux métaboliques correspondants disponibles sous forme de wikis sur la page Aureme Genouest.
...
**Description du projet et des données utilisées:**
mélange de données avec plusieurs bloques de données metabolomiques et des données biométriques (taille, poids, ...) ainsi que des données environmentales (T°, ...)
...
**Description du projet et des données utilisées:**
Intégration de données d'épigénomique et de transcriptomique
...
**Description du projet et des données utilisées:**
Jeux de données de transcriptomique (RNA-Seq) et d'épigénétique (ChIP-Seq)
...
**Description du projet et des données utilisées:**
Jeu de données métabolomique MS à combiner soit avec un autre jeu de données métabolomique RMN ou avec un jeu de données 16S rRNA amplicon sequencing
...
**Description du projet et des données utilisées:**
intégration de ces 2 types de données : WGS et RNAseq
...
**Description du projet et des données utilisées:**
Différents jeux de données: WGS, RNAseq, métagénomique...
...
**Description du projet et des données utilisées:**
données de probabilité par jour de décès par prédation pour plusieurs espèces estimé pour les longues périodes. La probabilité s’appliquerait pour un individu "fit", en forme, en bonne santé représentative pour chaque espèce.
...
**Description du projet et des données utilisées:**
table de corrélation de flux métabolite au sein d'organes (colon et ileon). Ce sont des matrices symétriques d'environ 7000x7000. 

**Objectifs:**
Je souhaite développer un moyen d'extraire de l'information pertinente à partir de comparaison de table de corrélation de flux métaboliques.
...
**Description du projet et des données utilisées:**
Données transcriptomiques, épigénomiques (ChIP-seq, méthylome) et phénotypiques sur un modèle aviaire ayant subit un traitement embryonnaire. 

**Objectifs:**
Ces données sont très lourdes donc probablement inexploitables lors d'un tel événement, mais je souhaiterais réfléchir à la façon d'intégrer toutes ces données.
...
**Description du projet et des données utilisées:**
Jeu de données transcriptomiques (obtenus à partir d'ARN extraits de cellules sanguines) et d'un jeu de données phénotypiques (résultats d'analyses comportementales d'agressivité) obtenus chez le cheval. 

**Objectifs:**
Je souhaite identifier s'il existe des gènes marqueurs du niveau d'agressivité chez le cheval, et dans quelles voies métaboliques sont impliqués ces gènes.
...
**Description du projet et des données utilisées:**
Compositional data of ruminal bacteria
...
**Description du projet et des données utilisées:**
kit elisa/épitopes protéiques homme-souris/rnaseq sgle-cell porc-poulet/génomes poissons
...
**Description du projet et des données utilisées:**
Données ECG / Données imagerie (IRM ToF) / Génomiques (VCFs) / données cliniques (simulée éventuellement)
