...
<details>
<summary>Projet fédérateur MoDaL</summary>

Projet fédérateur MoDaL (Multi Scale Data Linked)
MoDaL (Multi-scale Data Linked) est un projet interrégional porté par le réseau BioGenOuest qui vise à animer une large communauté scientifique autour de l’intégration de données hétérogènes (phénotypage et génotypage).
